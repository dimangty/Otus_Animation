package com.example.otusanimations
...
import com.example.otusanimations.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bmpCardFront = (ResourcesCompat.getDrawable(
            resources, R.drawable.card1, null
        ) as BitmapDrawable).bitmap
        bmpCardFront

        bmpCardBack = (ResourcesCompat.getDrawable(
            resources, R.drawable.card2, null
        ) as BitmapDrawable).bitmap
